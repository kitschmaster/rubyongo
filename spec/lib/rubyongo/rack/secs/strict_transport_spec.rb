...
describe Rubyongo::Rack::Secs::StrictTransport do
  ...
  it 'should allow changing the max-age option' do
    mock_app do
      use Rubyongo::Rack::Secs::StrictTransport, :max_age => 16_070_400
      run DummyApp
    end
  ...
  it 'should allow switching on the include_subdomains option' do
    mock_app do
      use Rubyongo::Rack::Secs::StrictTransport, :include_subdomains => true
      run DummyApp
    end
  ...
  it 'should allow switching on the preload option' do
    mock_app do
      use Rubyongo::Rack::Secs::StrictTransport, :preload => true
      run DummyApp
    end
  ...
  it 'should allow switching on all the options' do
    mock_app do
      use Rubyongo::Rack::Secs::StrictTransport, :preload => true, :include_subdomains => true
      run DummyApp
    end
