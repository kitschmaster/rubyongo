...
describe Rubyongo::Rack::Secs::PathTraversal do
  ...
  context 'escaping' do
    ...
    it 'should be able to deal with PATH_INFO = nil (fcgi?)' do
      app = Rubyongo::Rack::Secs::PathTraversal.new(proc { 42 })
  ...
  if "".respond_to?(:encoding)  # Ruby 1.9+ M17N
    context "PATH_INFO's encoding" do
      before do
        @app = Rubyongo::Rack::Secs::PathTraversal.new(proc { |e| [200, {'Content-Type' => 'text/plain'}, [e['PATH_INFO'].encoding.to_s]] })
      end
