...
describe Rubyongo::Rack::Secs::ContentSecurityPolicy do
  ...
  it 'should allow setting CSP3 no arg directives' do
    mock_app do
      use Rubyongo::Rack::Secs::ContentSecurityPolicy, :block_all_mixed_content => true, :disown_opener => true, :upgrade_insecure_requests => true
  ...
  it 'should ignore CSP3 no arg directives unless they are set to true' do
    mock_app do
      use Rubyongo::Rack::Secs::ContentSecurityPolicy, :block_all_mixed_content => false, :disown_opener => 'false', :upgrade_insecure_requests => 'foo'
  ...
  it 'should allow changing report only' do
    ...
    mock_app do
      use Rubyongo::Rack::Secs::ContentSecurityPolicy, :report_uri => '/my_amazing_csp_report_parser', :report_only => true
      run DummyApp
    end
