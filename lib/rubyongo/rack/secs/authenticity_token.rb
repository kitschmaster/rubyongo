...
module Rack
  module Secs
    ...
    #     use Rack::Secs::AuthenticityToken
    #
    #     run -> (env) do
    #       [200, {}, [
    #         <<~EOS
    ...
    #           <head>
    #             <meta charset="UTF-8" />
    #             <title>rack-secs minimal example</title>
    #           </head>
    #           <body>
    ...
    #   use Rack::Secs::AuthenticityToken, authenticity_param: 'your_token_param_name'
    class AuthenticityToken < ::Rubyongo::Rack::Secs::Base
      TOKEN_LENGTH = 32
